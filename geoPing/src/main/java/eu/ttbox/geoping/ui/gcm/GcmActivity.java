...
public class GcmActivity  extends Activity {
     ...
     */
    String SENDER_ID = GcmConst.PROJECT_NUMBER ; //"Your-Sender-ID";
            ...
            new AsyncTask<Void, Void, String>() {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    try {
                        ...
                        data.putString("my_action", "eu.ttbox.geoping.ECHO_NOW");
    ...
    private void sendRegistrationIdToBackend() {
        ...
        // create credential
        //credential = GoogleAccountCredential.usingAudience(this, GcmConst.AUTH_AUDIENCE);
